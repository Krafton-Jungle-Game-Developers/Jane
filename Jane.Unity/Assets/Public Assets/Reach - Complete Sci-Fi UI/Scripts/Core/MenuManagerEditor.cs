...
namespace Michsky.UI.Reach
{
    ...
    public class MenuManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ReachEditorHandler.DrawProperty(splashScreen, customSkin, "Splash Screen");
            ReachEditorHandler.DrawProperty(mainContent, customSkin, "Main Content");
            ReachEditorHandler.DrawProperty(initPanel, customSkin, "Init Screen");
            ReachEditorHandler.DrawProperty(controllerManager, customSkin, "Controller Manager");
