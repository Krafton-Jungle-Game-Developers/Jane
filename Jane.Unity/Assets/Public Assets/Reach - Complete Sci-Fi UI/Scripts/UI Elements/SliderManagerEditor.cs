...
namespace Michsky.UI.Reach
{
    ...
    public class SliderManagerEditor : Editor
    {
        ...
        {
            ReachEditorHandler.DrawComponentHeader(customSkin, "Slider Top Header");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    ReachEditorHandler.DrawProperty(sliderObject, customSkin, "Slider Source");
                    if (showValue.boolValue == true) { ReachEditorHandler.DrawProperty(valueText, customSkin, "Label Text"); }
                ...
                case 2:
                    ...
                    usePercent.boolValue = ReachEditorHandler.DrawToggle(usePercent.boolValue, customSkin, "Use Percent");
                    showValue.boolValue = ReachEditorHandler.DrawToggle(showValue.boolValue, customSkin, "Show Label");
                    showPopupValue.boolValue = ReachEditorHandler.DrawToggle(showPopupValue.boolValue, customSkin, "Show Popup Label");
                    useRoundValue.boolValue = ReachEditorHandler.DrawToggle(useRoundValue.boolValue, customSkin, "Use Round Value");
