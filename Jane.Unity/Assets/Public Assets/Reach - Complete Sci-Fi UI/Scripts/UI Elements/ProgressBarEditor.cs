...
namespace Michsky.UI.Reach
{
    ...
    public class ProgressBarEditor : Editor
    {
        ...
        {
            ReachEditorHandler.DrawComponentHeader(customSkin, "Progress Bar Top Header");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (pbTarget.barImage != null) { ReachEditorHandler.DrawPropertyCW(icon, customSkin, "Bar Icon", 99); }
                ...
                case 2:
                    ...
                    ReachEditorHandler.DrawPropertyCW(decimals, customSkin, "Decimals", 80);
                    ...
                    ReachEditorHandler.DrawPropertyCW(barDirection, customSkin, "Bar Direction", 80);
                    break;
            }
