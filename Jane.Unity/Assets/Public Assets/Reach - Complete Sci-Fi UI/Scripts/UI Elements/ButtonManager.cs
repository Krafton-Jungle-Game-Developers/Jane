...
namespace Michsky.UI.Reach
{
    ...
    public class ButtonManager : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        void OnEnable()
        {
            ...
            if (bypassUpdateOnEnable == false) { UpdateUI(); }
        }
        ...
        void Initialize()
        {
            ...
            if (useLocalization == true && useCustomContent == false)
            {
        ...
        public void UpdateUI()
        {
            ...
            if (disabledLayout != null && autoFitContent == true) { disabledLayout.padding = new RectOffset(padding.left, padding.right, padding.top, padding.bottom); disabledLayout.spacing = spacing; }
            if (normalLayout != null && autoFitContent == true) { normalLayout.padding = new RectOffset(padding.left, padding.right, padding.top, padding.bottom); normalLayout.spacing = spacing; }
            if (highlightedLayout != null && autoFitContent == true) { highlightedLayout.padding = new RectOffset(padding.left, padding.right, padding.top, padding.bottom); highlightedLayout.spacing = spacing; }
        ...
        public void UpdateState()
        {
            if (Application.isPlaying == false || gameObject.activeInHierarchy == false) { return; }
            if (isInteractable == false) { StartCoroutine("SetDisabled"); }
            else if (isInteractable == true) { StartCoroutine("SetNormal"); }
        }
