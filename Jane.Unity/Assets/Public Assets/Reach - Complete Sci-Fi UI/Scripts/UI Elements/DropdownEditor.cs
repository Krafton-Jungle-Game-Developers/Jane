...
namespace Michsky.UI.Reach
{
    ...
    public class DropdownEditor : Editor
    {
        ...
        {
            ReachEditorHandler.DrawComponentHeader(customSkin, "Dropdown Top Header");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    ReachEditorHandler.DrawProperty(triggerObject, customSkin, "Trigger Object");
                    ReachEditorHandler.DrawProperty(headerText, customSkin, "Header Text");
                    ReachEditorHandler.DrawProperty(headerImage, customSkin, "Header Image");
                    ...
                    ReachEditorHandler.DrawProperty(scrollbar, customSkin, "Scrollbar");
                    ReachEditorHandler.DrawProperty(highlightCG, customSkin, "Highlight CG");
                    ReachEditorHandler.DrawProperty(contentCG, customSkin, "Content CG");
                    ReachEditorHandler.DrawProperty(listCG, customSkin, "List CG");
                    ReachEditorHandler.DrawProperty(listRect, customSkin, "List Rect");
                    break;

                case 2:
                    ReachEditorHandler.DrawHeader(customSkin, "Customization Header", 6);
                    enableIcon.boolValue = ReachEditorHandler.DrawToggle(enableIcon.boolValue, customSkin, "Enable Header Icon");
                    ...
                    enableScrollbar.boolValue = ReachEditorHandler.DrawToggle(enableScrollbar.boolValue, customSkin, "Enable Scrollbar");
                    ...
                    startAtBottom.boolValue = ReachEditorHandler.DrawToggle(startAtBottom.boolValue, customSkin, "Start At Bottom");

                    ReachEditorHandler.DrawPropertyCW(itemSpacing, customSkin, "Item Spacing", 90);
                    ...
                    ReachEditorHandler.DrawHeader(customSkin, "Animation Header", 10);
                    ReachEditorHandler.DrawProperty(panelDirection, customSkin, "Panel Direction");
                    ReachEditorHandler.DrawProperty(panelSize, customSkin, "Panel Size");
                    ReachEditorHandler.DrawProperty(curveSpeed, customSkin, "Curve Speed");
                    ReachEditorHandler.DrawProperty(animationCurve, customSkin, "Animation Curve");

                    ReachEditorHandler.DrawHeader(customSkin, "Options Header", 10);
                    initOnAwake.boolValue = ReachEditorHandler.DrawToggle(initOnAwake.boolValue, customSkin, "Initialize On Awake");
                    invokeOnAwake.boolValue = ReachEditorHandler.DrawToggle(invokeOnAwake.boolValue, customSkin, "Invoke On Awake", "Process events on awake.");

                    enableTrigger.boolValue = ReachEditorHandler.DrawToggle(enableTrigger.boolValue, customSkin, "Enable Trigger", "Clicking outside will close the dropdown.");
                    ...
                    setHighPriority.boolValue = ReachEditorHandler.DrawToggle(setHighPriority.boolValue, customSkin, "Set High Priority");
                    ...
                    outOnPointerExit.boolValue = ReachEditorHandler.DrawToggle(outOnPointerExit.boolValue, customSkin, "Out On Pointer Exit", "Close the dropdown on pointer exit.");
                    useSounds.boolValue = ReachEditorHandler.DrawToggle(useSounds.boolValue, customSkin, "Use Sounds");
                 
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    saveSelected.boolValue = ReachEditorHandler.DrawTogglePlain(saveSelected.boolValue, customSkin, "Save Selected");                 
                    GUILayout.Space(3);

                    if (saveSelected.boolValue == true)
                    {
                        ReachEditorHandler.DrawPropertyPlainCW(saveKey, customSkin, "Save Key:", 66);
