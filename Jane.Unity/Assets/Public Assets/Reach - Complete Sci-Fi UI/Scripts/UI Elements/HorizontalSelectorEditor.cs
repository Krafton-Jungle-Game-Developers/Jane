...
namespace Michsky.UI.Reach
{
    ...
    public class HorizontalSelectorEditor : Editor
    {
        ...
        {
            ReachEditorHandler.DrawComponentHeader(customSkin, "Horizontal Selector Top Header");
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    ReachEditorHandler.DrawProperty(selectorAnimator, customSkin, "Animator");
                    ReachEditorHandler.DrawProperty(label, customSkin, "Label");
                    ReachEditorHandler.DrawProperty(labelHelper, customSkin, "Label Helper");
                    ReachEditorHandler.DrawProperty(labelIcon, customSkin, "Label Icon");
                    ReachEditorHandler.DrawProperty(labelIconHelper, customSkin, "Label Icon Helper");
                    ReachEditorHandler.DrawProperty(indicatorParent, customSkin, "Indicator Parent");
                    ReachEditorHandler.DrawProperty(indicatorObject, customSkin, "Indicator Object");
                    ReachEditorHandler.DrawProperty(contentLayout, customSkin, "Content Layout");
                    ReachEditorHandler.DrawProperty(contentLayoutHelper, customSkin, "Content Layout Helper");
                    break;
                ...
                case 2:
                    ...
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    enableIndicator.boolValue = ReachEditorHandler.DrawTogglePlain(enableIndicator.boolValue, customSkin, "Enable Indicators");
                    GUILayout.Space(3);
                    GUILayout.BeginHorizontal();
                    ...
                    ReachEditorHandler.DrawProperty(iconScale, customSkin, "Icon Scale");
                    ReachEditorHandler.DrawProperty(contentSpacing, customSkin, "Content Spacing");
                    GUI.enabled = true;
                    ...
                    invertAnimation.boolValue = ReachEditorHandler.DrawToggle(invertAnimation.boolValue, customSkin, "Invert Animation");
                    loopSelection.boolValue = ReachEditorHandler.DrawToggle(loopSelection.boolValue, customSkin, "Loop Selection");
                    ...
                    {
                        ReachEditorHandler.DrawPropertyCW(saveKey, customSkin, "Save Key:", 66);
